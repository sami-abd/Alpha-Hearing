...
//REQUIRES: ADDR3-0 to be 0 in order to start reading the SD card
//PROMISES: starts the reading event and checks if the card is ready to read.
bool Start_Read(char ADDR3, char ADDR2, char ADDR1, char ADDR0);
